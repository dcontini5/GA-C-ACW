...
class UpdateFrequencyMessage : public Message{
	...
	//Structors
public:
	UpdateFrequencyMessage(const SystemType& pSystem, const short& pFrequency): Message(PyramidClientMessageTypes::UPDATE_FREQUENCY), mSystem(pSystem), mFrequency(pFrequency) {}
